...
function Mensaje(textShow, tipo, callback) {
    ...
    bootbox.alert({
        // size : "small",
        message : _message,
        className: 'bootboxSinBorde mayus text-center',
        buttons : {
            ok : {
                label : 'Cerrar',
                className : ''
...
function _confirm(textShow, tipo, callback) {
    ...
    bootbox.confirm({
        // size : "small",
        message : _message,
        className: 'bootboxSinBorde mayus',
        buttons : {
            confirm : {
                label : 'Aceptar',
                className : ''
...
function mostrarPDF(data) {
    ...
    bootbox.alert({
        size: "large",
        message: '<iframe src="' + data + '" style="width:100%;height:100%" frameborder="0"></iframe>',
        className: "bootboxSinBorde alertPDF",
        buttons : {
            ok : {
                label : 'Cerrar',
                className : ''
